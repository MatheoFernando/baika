    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          aria-label={locale}
          className={cn(
            "flex items-center gap-2 cursor-pointer focus:border-gray-700 dark:focus:border-gray-300 rounded-lg px-3 py-2 bg-white dark:bg-gray-800/80 backdrop-blur-sm border border-white/20 dark:border-gray-700/20 hover:bg-white/90 dark:hover:bg-gray-800/90 transition-all",
            className,
          )}
        >
          <Image
